...
export class UserProfileComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.id = id.value;
    this.header = new HttpHeaders().append(
      'Authorization',
      `Bearer ${this.token}`
    );
  }
  ...
  fetchUserData() {
    ...
    this.http
      .get(env.api + `users/${this.userId}/followers`, { headers: this.header })
      .subscribe(
        (data: any) => {
          this.followers = data;
        },
    ...
    this.http
      .get(env.api + `users/${this.userId}/followings`, {
        headers: this.header,
      })
      .subscribe(
        (data: any) => {
  ...
  handleFollow() {
    ...
    this.http
      .post(env.api + `follows`, body, { headers: this.header })
      .subscribe(
        () => {
